'''
3.	Orchestra(s)+continent, within a period of choice; results both in absolute and proportional figures
Part1:
Part2:
Part3:
'''
...
def get_dates():
    """
    Gets the dates and returns output filtered between the two input dates
    """
...
if __name__ == '__main__':
    ...
    lbl = Label(window, text="Orchestra(s)+Continent, "
